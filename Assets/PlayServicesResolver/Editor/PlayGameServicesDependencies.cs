...
{
	[InitializeOnLoad]
	public static class PlayGameServicesDependencies
	{
	    private static readonly string PluginName = "PlayGameServicesPlugin";
		...
		static PlayGameServicesDependencies()
	    {
			...
			svcSupport.DependOn( "com.google.android.gms", "play-services-plus", "9+" );
	    }
